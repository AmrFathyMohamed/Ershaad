...
<head>
  <meta charset="utf-8" />
  <title>استكمال بيانات الحساب</title>
        ...
        <div class="col-lg-6 mx-auto wow fadeIn mt-3" data-wow-delay="0.5s">
          <div class="bg-light rounded p-5 pb-3 px-sm-3">
            <form method="POST" action="updatedata.php">
              <div class="row g-3">
                <h4 class="text-center mb-4">استكمال بيانات الحساب</h4>
                ...
                <div class="col-sm-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="FullName" name="FullName" placeholder="الاسم كامل"
                      value="<?= $client['FullName'] ?>" readonly />
                    <label for="FullName"> الاسم كامل</label>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="Username" name="Username" placeholder="أسم المستخدم "
