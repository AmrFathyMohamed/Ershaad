...
<div class="collapse navbar-collapse" id="navbarCollapse">
  <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
    ...
    <a href="courses.html" class="nav-item nav-link px-3 active">الكورسات</a>
...
<!-- Navbar End -->
      ...
      <div class="container pb-3 pt-5"> 
        <nav aria-label="breadcrumb animated slideInDown ">
          <div class="d-flex justify-content-between">
            ...
            <div>
              <button class="btn btn-primary btn-sm px-4" data-bs-toggle="modal" data-bs-target="#requestCourseModal"><i class="fa-solid fa-pencil me-2"></i>طلب أضافة كورس</button>
            </div>
          </div>
    ...
    <ul class="nav nav-pills mb-3 justify-content-center" style="gap: 7rem;" id="pills-tab" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link px-5 rounded-0 active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"> الكورسات</button>
      </li>
    </ul>
        ...
        <div class="col-lg-10 mt-3 wow fadeInUp" data-wow-delay="0.1s">
          <div class="service-item rounded h-100 px-4 pb-2">
            <div class="ms-n5 mb-1">
              ...
              <h4 class="mb-0 w-100 text-right">كيفية التخلص من الوسواس القهري</h4>
              <p class="text-right w-100">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Recusandae suscipit consequuntur cumque obcaecati quas eius!</p>
            </div>
           <div class="d-flex justify-content-between">
            <p class=" mb-0 text-right">
              <i class="fa-solid fa-hand-holding-dollar" style="color: #6eaedc;"></i> 300 ج.م
            </p>
            <p class=" mb-0 text-right">
             6 جلسات <i class="fa-regular fa-calendar-check" style="color: #6eaedc;"></i>
            </p>
           </div>
          </div>
        </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body row">
        ...
        <div class="col-12">
          <textarea name="" id="" cols="30" rows="6" placeholder="التفاصيل " class="rtl arabic form-control mt-3"></textarea>
        </div>
