                    ...
                    <ul class="navbar-nav d-flex align-items-center navbar-light ms-auto">
                        ...
                        <li class="dropdown">
                            <a href="#" data-bs-toggle="dropdown"
                                ...
                                <div class="d-none d-md-block d-lg-inline-block"><?php echo $_SESSION['fullname'];?></div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="logout.php?logout=true"><i data-feather="log-out"></i> Logout</a>
                            </div>
                        </li>
                    </ul>
                </div>
