    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">Post Ad image</h5>
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                        <label for="Ad Image" class="form-label">Ad Image</label>
                        <input type="file" class="form-control" id="AdImage" required accept="image/*">
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" name="addAd">Post Ad</button>
                    </div>
                </form>
