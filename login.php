              ...
              <div class="row g-3">
                ...
                <div class="col-sm-12">
                  <div class="form-floating">
                    <input type="email" class="form-control rtl" id="email" name="email"
                ...
                <?php } ?>
                <p class="mt-5 text-center"> نسيت كلمة المرور؟ <a class="text-primary pointer" data-bs-toggle="modal"
                    data-bs-target="#forgetPassModal">إسترجاع</a>
    ...
    document.getElementById("email-form").addEventListener("submit", function (event) {
      ...
      emailjs.send("service_66qxkf7", "template_g9q8u4c", {
        ...
        $.post('send_email.php', { email: email, randomPassword: randomPassword }, function (data) {
          ...
          console.log(data); // You can display or process the response as needed
        });
      }, function (error) {
